...
```{r}
#separate by invaded and uninvaded
redI.HTblooms<-as.data.frame(table(redI.SBHTBloom[,c("Lake_Name","Sample_Year", "HTBloom")]))
redI.HTblooms$Dreissenids<-rep("Invaded", 40)

redU.HTblooms<-as.data.frame(table(redU.SBHTBloom[,c("Lake_Name","Sample_Year", "HTBloom")]))
redU.HTblooms$Dreissenids<-rep("Uninvaded", 30)
