...
tab_model(TNTP, file="./output_data/TNTP-global.html")
```
...
tab_model(BSTP, file="./output_data/BSTP-global.html")
```
...
tab_model(Chl, file="./output_data/Chl-global.html")
```
...
tab_model(Secchi, file="./output_data/Secchi-global.html")
```
...
tab_model(TC, file="./output_data/TC-global.html")
```
...
tab_model(SBChl, file="./output_data/SBChl-global.html")
```
...
tab_model(SBmicro, file="./output_data/SBmicro-global.html")
```
...
tab_model(OWmicro, file="./output_data/OWmicro-global.html")
```
...
tab_model(redTNTP, file="./output_data/TNTP-reduced.html")
```
...
tab_model(redBSTP, file="./output_data/BSTP-reduced.html")
```
...
tab_model(redChl, file="./output_data/Chl-reduced.html")
```
...
tab_model(redSecchi, file="./output_data/Secchi-reduced.html")
```
...
tab_model(redOWTC, file="./output_data/TC-reduced.html")
```
...
tab_model(redSBChl, file="./output_data/SBChl-reduced.html")
```
...
```{r}
redSBmicro<-lmer(log(ESF_Microcystin) ~ Dreissenids + log(TN_TP) + log(CA.SA) + log(Mean_Depth_m) + Percent_Ag + (1|Sample_Year)  , data=redSBCSLAP)
...
tab_model(redSBmicro, file="./output_data/SBmicro-reduced.html")
```
...
tab_model(redOWmicro, file="./output_data/OWmicro-reduced.html")
```
...
ggsave("./output_figures/Bloom Freq Boxplot.png")
```
...
ggsave("./output_figures/HT Bloom Freq Boxplot.png")
```
...
ggplot(OWcompleteBloom, aes(x=TP, y=ESF_Microcystin, color=Dreissenids, shape=Dreissenids)) +
  ...
  scale_color_manual(values=c("#EE4526","#33C14A"))+
...
ggsave("./output_figures/Fig 2-1 CAPSTONE.png")
...
ggsave("./output_figures/Fig 2-3 CAPSTONE.png")
...
ggsave("./output_figures/Fig 2-2 CAPSTONE.png")
